...
void EMPLOYEE :: NEW_EMPLOYEE(void)
{
	...
	char  ename[26], eaddress[31], ephone[11], edesig[16], t1[10] ;
...
initgraph(&gd, &gm, "C://turboc3//bgi");
 setbkcolor(MAGENTA);
 setcolor(WHITE);
 //ellipse(320,250,0,360,350,260);
 //ellipse(320,250,0,360,300,200);
for(int j=1;j<50;j++)
 {
 ellipse(320,250,0,360,300-j,190-j);
 delay(30);
 }
 setcolor(YELLOW);
 moveto(180,150);
